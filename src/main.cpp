...
int main(int argc, char* argv[]) {
    ...
    while (running) {
        while (SDL_PollEvent(&e)) {
            ...
            if (e.type == SDL_KEYDOWN) {
                ...
                if (key == SDLK_ESCAPE) running = false;
                    ...
                    if (inputBuffer == "clear") lines.clear();
                    else if (inputBuffer == "help") lines.push_back("Available: help, exit, version, clear");
                    else if (inputBuffer == "version") lines.push_back("Tervinal v1.0.0");
                    else if (inputBuffer == "exit") running = false;
                    inputBuffer.clear();
        ...
        if (!currentSuggestion.empty()) {
            ...
            sugRect.x = 20 + inputRect.w; sugRect.y = y;
